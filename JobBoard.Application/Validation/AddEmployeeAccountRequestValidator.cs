...
{
    public class AddEmployeeAccountRequestValidator : AbstractValidator<AddEmployeeAccountRequest>
    {
        public AddEmployeeAccountRequestValidator()
        {
            ...
            RuleFor(r => r.Password).NotEmpty().Length(8, 100);
